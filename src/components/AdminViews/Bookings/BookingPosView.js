...
const BookingPosView = () => {
  ...
  const {
    ...
    baseURL: `${process.env.REACT_APP_POS_URL}/api/v1`,
    method: 'post',
    enabled: true,
  ...
  return (
    <>
      <section className="mobile-view-pad">
        <Row className="booking-headers booking-headers--pos">
          <BookingHeader
